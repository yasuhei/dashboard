...
export function Header() {
  return(
    ...
    <Input  color='gray.50' variant='unstyled' placeholder='Buscar em toda plataforma' _placeholder={{ color: 'gray.400'}} px='4' mr='4'/>
   ...
   <Icon as={RiSearchLine} fontSize='20'/>
    ...
    <Box mr='4' text-align="right">
      ...
      <Text color='gray.300' fontSize='small'>yasuhei_nakamura@hotmail.com</Text>
    </Box>
